...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <a href="./login.php" class="book-a-table-btn scrollto d-none d-lg-flex">singup</a>
                                ...
                                <div class="flex justify-around  h-[20vh] w-full text-center mt-5">
                                    ...
                                    <div class="w-[22vw] h-[20vh]  rounded-lg bg-no-repeat object-fill">
                                        <a href="./views/villes.php?id=<?= $row['ID']; ?>">
                                            <img class="rounded-t-lg w-[20vw] h-[10vh] " src="assets/img/about-bg.jpg"
   ...
   <?php foreach ($data as $row) { ?>
    <div class="col-lg-6 menu-item filter-starters">
        ...
        <div class="menu-content">
            <a href="#"><?= htmlspecialchars($row['name'], ENT_QUOTES, 'UTF-8') ?></a><span>$<?= htmlspecialchars($row['prix'], ENT_QUOTES, 'UTF-8') ?>,99</span>
        </div>
        <div class="menu-ingredients">
            <?= htmlspecialchars($row['descreption'], ENT_QUOTES, 'UTF-8') ?>
        </div>     
    </div>
<?php } ?>
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
          ...
          <p>Book a Table</p>
            ...
            if ($result && $result->num_rows > 0) {
                ...
                $reservation = [];
                        ...
                        // 5asna function hna dyal suppremer
            ...
            if ($reserv['Répondre'] == 0 && $reserv['id_utilisateur'] == $id_user) {
              ...
              <div>reservation de :  <?=$reserv['date_reservation'] ?></div>
              <form action="" method="POST">
              ...
              <?php
            }else if ($reserv['Répondre']== 2 && $reserv['id_utilisateur'] == $id_user) {
              ?>
              <div class="w-full h-10 bg-red-500 rounded-xl flex justify-evenly items-center mb-2">
              <div>reservation de :  <?=$reserv['date_reservation'] ?></div>
              <form action="" method="POST">
                <input type="hidden" value=" <?=$reserv['id_reservation'] ?>">
                <button type="submit" class="h-6 w-16 bg-red-900 rounded-lg">annuler</button>
        ...
        <form action="" method="POST" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          ...
          class="text-lg  text-[#CDA55E] text-opacity-70 font-semibold" >Menu</label>
          <select class="text-gray-30000 w-full bg-[#CDA55E] h-10 rounded-xl mt-3" name="menu" id="">
    <?php 
    foreach ($data as $row2) {
    ?>
    <option value="<?= htmlspecialchars($row2['id_menu'], ENT_QUOTES, 'UTF-8') ?>">
        <?= htmlspecialchars($row2['name'], ENT_QUOTES, 'UTF-8') ?>
    </option>
    <?php } ?>
</select>
